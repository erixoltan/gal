...
sub Gs_Enquote($Text)
{
    ...
    return "'ERROR bootstrap.raku DEEPLY ENQUOTED GS STRING FAILED HERE'";
}
...
class Element 
{
    ...
    method AddType($Name, $Type)
    {
        ...
        die "Parent Required by $.^name for AddType";
    }
...
class Named_Element is Element
{
    ...
    method Classify($name, $document, $start, $end) 
    {
        unless defined($name)
        {
            die "$.^name Classify keyword undefined - did you do () or [] or something??";
        }
...
class Statement_Numbers {...}
class Statement_Oho {...}
class Statement_Operation {...}
class Statement_Optional {...}
class Statement_Our_Equals {...}
...
class Quote is Punct_Element
{
    ...
    method Classify($Text, $Document, $Start, $End)
    {
        ...
        if $Char eq '`'
        {
            return Quote_Backquote.new(Text => $Text, Document => $Document, StartPos => $Start, EndPos => $End);
        }
        # TODO: European quotes.
        my $Whoops; return $Whoops;
    }
    method Gal_Generate()
    {
...
class Statement is Named_Element 
{
    ...
    our %.Classes = 
        'add' => Statement_Add, '+' => Statement_Add,  '+=' => Statement_Add,
        ...
        'classpropset' => Statement_Classpropset, ':=' => Statement_Classpropset,
        ...
        'entity.class' => Statement_Entity_Class, 'entity.my.class' => Statement_Entity_Class,
        ...
        'hash' => Statement_Hash, 'dict' => Statement_Hash, 'dictionary' => Statement_Hash,
        'hash.assign' => Statement_Hash_Assign, 'dict.assign' => Statement_Hash_Assign, 'dict.=' => Statement_Hash_Assign,
        ...
        'i' => Statement_I, 'we' => Statement_I, 
        'if' => Statement_If, 
        'ifdef' => Statement_Ifdef,
        ...
        'my=' => Statement_I_Equals, 'my.=' => Statement_I_Equals, 
        'new' => Statement_New,
        'number' => Statement_Number,
        'numbers' => Statement_Numbers,
        'oho' => Statement_Oho,
        'operation' => Statement_Operation,
        'optional' => Statement_Optional,
        'our=' => Statement_Our_Equals, 'our.=' => Statement_Our_Equals,
        ...
        'returnif' => Statement_Returnif, 'return.if' => Statement_Returnif,
        ...
        'try' => Statement_Try,
        'undef' => Statement_Undef,
        'unless' => Statement_Unless,
        'variant' => Statement_Variant,
        'verb' => Statement_Verb, 'polymorph' => Statement_Verb,
...
class Function is Named_Element
{
    ...
    our %.Classes = 
        ...
        'dict.exists' => Function_Keyexists, 'dict.get' => Function_Dict_Get,
        ...
        'string.eq' => Function_StringEqual, 's=' => Function_StringEqual,
        'string.ne' => Function_StringNotEqual, 's.ne' => Function_StringNotEqual, 
        'exp' => Function_Exp,
        ...
        'i' => Function_I, 'we' => Function_I, 'me' => Function_I, 'my' => Function_I,
        'isa' => Function_Isa,
        ...
        'string.le' => Function_StringLessEqual, 's.le' => Function_StringLessEqual, 'sle' => Function_StringLessEqual,
        'string.ge' => Function_StringGreaterEqual, 's.ge' => Function_StringGreaterEqual, 'sge' => Function_StringGreaterEqual,
        'string.lt' => Function_StringLess, 's.lt' => Function_StringLess, 'slt' => Function_StringLess,
        'string.gt' => Function_StringGreater, 's.gt' => Function_StringGreater,  'sgt' => Function_StringGreater,
...
class Syntax is Named_Element
{
    ...
    our %.Classes = 
        ...
        'class' => Syntax_Class, ':' => Syntax_Class,
        'classprop' => Syntax_Classprop, 'class.property' => Syntax_Classprop, 'cp' => Syntax_Classprop, 'our' => Syntax_Classprop,
        'class.self' => Syntax_Class_Self, 'my.class' => Syntax_Class_Self,
...
class Append_Args_Statement is Line_Statement 
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: append_args_statement Argument $Argument has no .Raku";
...
class Statement_Append is Line_Statement 
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: append statement Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            if $RakuArgs eq ""
            {
...
class Statement_String is Multi_Declare_Statement
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: Statement_String Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            if $RakuArgs eq ""
            {
...
class Statement_Numbers is Line_Statement
{
    ...
    method Gal_Generate()
    {
        ...
        for @.Arguments -> $Argument
        {
            $Gal_Code ~= $Between ~ "number " ~ $Argument.Gal ~ ";";
            $Between = "\n";
        }
        $.Gal = $Gal_Code;
    }
...
class Statement_Entity_New is Line_Statement 
{
    ...
    method Gal_Generate()
    {
        my @Args = @.Arguments;
        my $Variable = @Args.shift();
        my $VarGal = $Variable.Gal;
        my $Class_Name = @Args.shift();
        my $ClassGal = $Class_Name.Gal;
        my $Arg;
        my $ArgsGal = "";
        for @Args -> $Arg
        {
        ...
        my Str $Gal_Body = "entity $VarGal (new :$ClassGal$ArgsGal);";
        $.Gal = $Gal_Body;
    }
}

class Statement_Entity_Class is Line_Statement 
{
    our $.Gal_Keyword = 'entity.class';
    method Attributes()
    {
        my @Args = @.Arguments;
        my $Variable = @Args.shift();
    ...
    method Raku_Generate()
    {
        ...
        my $VariableRaku = $Variable.Raku;
        my $RakuCode = "my $VariableRaku = \$\.new\($RakuArgs\);";
        $.Raku = $RakuCode;
        #say $RakuCode;
        #say "Entity New End\n";
    }
...
class Statement_Our_Equals is Line_Statement 
{
...
class Statement_Classpropset is Line_Statement 
{
    ...
    {
        my $ClassGal = $.Class_Name.Gal;
        my $PropGal = $.Property.Gal;
        my $ValGal = $.Value.Gal;
        my Str $Gal_Body = ".= :$ClassGal $PropGal $ValGal;";
        $.Gal = $Gal_Body;
    }
}
...
class Statement_List_Append is Line_Statement 
{
    ...
    { 
        ...
        for @Args -> $Argument
        {
            $ValueCode ~= ", " unless $ValueCode eq '';
            $ValueCode ~= $Argument.Raku;
        }
...
class Statement_Language is Definition_Statement
{
    ...
    method Gal_Generate()
    {
        my Str $Gal_Body = $.Indent($.Declarations);
        if $.Block
        {
...
class Statement_Token is Definition_Statement
{
    ...
    method Gal_Generate()
    {
        my Str $Gal_Body = "todo;\n" ~ $.Declarations;
        $Gal_Body = $.Indent($Gal_Body);
        if $.Block
        {
            $Gal_Body ~= $.Block.Statement_Gal;
        }
        my Str $Gal_Code = "class :" ~ $.Name.Gal ~ " [is :Token]\n\{\n$Gal_Body\}";
        $.Gal = $Gal_Code;
    }
    method Model() { } 
    method Prepare() { } 
...
class Statement_Ifdef is If_Statement 
{
    our $.Gal_Keyword = 'if';
    method Gal_Generate()
    {
        ...
        for @.Arguments -> $Argument
        {
            $Arg_Gal ~= $Between ~ 'defined(' ~ $Argument.Gal ~ ')';
            $Between = " && ";
        }
        my Str $Gal_Code = "if " ~ $Arg_Gal ~ " " ~ $.Block.Gal;
        $.Gal = $Gal_Code;
    }
}
class Statement_Undef is If_Statement 
{
    our $.Gal_Keyword = 'if';
    method Gal_Generate()
    {
...
class Http_Statement is Scoped_Statement
{
    ...
    method Raku_Generate()
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: Http Statement Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            if $RakuArgs eq ""
            {
...
class Statement_License is Line_Statement
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: license Argument $Argument has no .Raku";
                say $Argument.Express();
            }
...
class Statement_Comment is Line_Statement
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: comment Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            #$ArgRakuCode = Unquote($ArgRakuCode);
...
class Statement_Todo is Line_Statement
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: todo Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            $ArgRakuCode = Unquote($ArgRakuCode);
            if $RakuArgs eq ""
...
class Statement_Author is Line_Statement
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: authorr Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            $ArgRakuCode = Unquote($ArgRakuCode);
            if $RakuArgs eq ""
...
class Statement_Oho is Line_Statement
{
    our $.Gal_Keyword = 'oho';
    has $.RakuStatement = "# optimize human outcome. ";
    method Raku_Generate() 
    {
        my @Arguments;
        my Element $Argument;
...
class Statement_Definition is Line_Statement
{
    ...
    method Raku_Generate() 
    {
        ...
        for @.Arguments -> $Argument
        {
            ...
            unless $ArgRakuCode
            {
                say "ERROR: definition Argument $Argument has no .Raku";
                say $Argument.Express();
            }
            $ArgRakuCode = Unquote($ArgRakuCode);
            if $RakuArgs eq ""
...
class Statement_Colon is Line_Statement
{
    our $.Gal_Keyword = ':';
    ...
    method Attributes()
    {
        ...
        #say ": Class ", $.Class_Name.Text, ', Method ', $.Method.Text;
    }
    method Raku_Generate()
    {
        #say "Raku Generate $.^name $.Name ...";
        my $MethodName = $.Method.Raku;
        #my $MethodName = $MethodName.lc();
        my $ClassRaku = $.Class_Name.Raku;
        my $RakuCode = $ClassRaku ~ '.' ~ $MethodName ~ '(';
        my $Argument;
        my $Between = "";
        for @.Meth_Args -> $Argument
        {
...
class Function_Colon is Function
{
    our $.Gal_Keyword = ':';
    has $.Class_Name is rw = '';
    ...
    method Attributes()
    {
        ...
        $.Method_Name.Usage = 'method';
    }
    method Raku_Generate()
    {
        my @Args = @.Listargs;
        my $ClassRaku = $.Class_Name.Raku;
        my $MethodName = $.Method_Name.Raku;
        if $MethodName.starts-with('$')
        {
            $MethodName = $MethodName.substr(1);
        }
...
class Syntax_Class is Syntax 
{
    ...
    method Raku_Generate() 
    {
        my $Raku = $.Class_Name.Text;
        my $Element;
        for @.Args -> $Element
        {
            my $PropertyText = $Element.Text;
            $Raku ~= "\.$PropertyText";
        }
        $.Raku = $Raku;
    }
...
class Generator 
{
    ...
    method Test_Generate($Document)
    {
        ...
        for $Document.Elements -> $Element
        {
            my $TC = "";
            my $Keep = False;
            #say "TC Generating: ", $Element.Express();
            $TC ~= "test case " ~ $Element.^name ~ "\n" ~ '{' ~ "\n";
            #if (defined($Element.Text) && $Element.Text gt "")
            #{
            #    $TC ~= '    text ' ~ '“' ~ $Element.Text ~ '”;' ~ "\n";
            #}
            if (defined($Element.Gal))
            {
                $TC ~= '    gal = ' ~ Gs_Enquote($Element.Gal) ~ ';' ~ "\n";
                $Keep = True;
            }
            if (defined($Element.Raku))
            {
                $TC ~= '    raku = ' ~ Gs_Enquote($Element.Raku) ~ ';' ~ "\n";
                $Keep = True;
            }
            if (defined($Element.Python))
            {
                $TC ~= '    python = ' ~ Gs_Enquote($Element.Python) ~ ';' ~ "\n";
                $Keep = True;
            }
            if (defined($Element.Javascript))
            {
                $TC ~= '    javascript = ' ~ Gs_Enquote($Element.Javascript) ~ ';' ~ "\n";
                $Keep = True;
            }
            $TC ~= '}' ~ "\n";
            next unless $Keep;
            next if defined(%Index{$TC});
            %Index{$TC} = True;
            $Text ~= $TC;
        }
        $Document.Test_Code = $Text;
    }
}
...
{
    my $verbose_tokens = True;
    my $document_text = False;
    ...
    $Document.Read();
    if $verbose and $document_text
    { 
        say "Document Text:\n", $Document.Text; 
    }
    say "Tokenizing\n" if $verbose and $verbose_tokens;
    Parser.Tokenize($Document);
    $Document.Dump(True) if $verbose and $verbose_tokens;
    say "Parsing\n" if $verbose;
    ...
    if $gal
    {
        ...
        # NOTE: problem, we use '.gal' for both the gal and the fallback!
        # Generator.Test_Generate($Document);
        # spurt("$target.gs", $Document.Test_Code);
    }
    if $raku
    {
        if $verbose {
        ...
        say "        Generate tests to $target.gs";
        Generator.Test_Generate($Document);
        spurt("$target.gs", $Document.Test_Code);
        #say "Printing Final Report";
    }
    if $python
    {
